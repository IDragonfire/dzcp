...
switch ($action):
    default:
        ...
        while ($get = _fetch($qry)) {
            ...
            if (_rows($qrydl)) {
                ...
                while ($getdl = _fetch($qrydl)) {
                    ...
                    $link = show(_downloads_link, array(
                        "id" => $getdl['id'],
                        "download" => $download,
                    ...
                    $show .= show($dir . "/downloads_show", array(
                        "class" => $class,
                        "link" => $link,
                        "kid" => $get['id'],
                        "display" => $display,
                ...
                if (cnt($db['downloads'], "WHERE kat = '" . $get['id'] . "'") == 1)
                    $dltitel = _dl_file;
                else
                    $dltitel = _site_stats_files;
                
                
                $kat = show(_dl_titel, array(
                    "id" => $get['id'],
                    "icon" => $moreicon,
                    "file" => $dltitel,
                    "cnt" => $cntKat,
                ...
                $kats .= show($dir . "/download_kats", array(
                    "kat" => $kat,
                    "class" => $class,
                    "kid" => $get['id'],
                    "img" => $img,
        ...
        $index = show($dir . "/downloads", array(
            "kats" => $kats,
    ...
    case 'download';
        if (settings("reg_dl") == 1 && $chkMe == "unlogged") {
            ...
            $getfile = show(_dl_getfile, array(
                "file" => $rawfile
            ));
