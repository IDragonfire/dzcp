...
if ($chkMe != 4) {
    ...
    if ($_GET['do'] == "add") {
        $show = show($dir . "/form_profil", array(
            "head" => _profile_add_head,
            "name" => _profile_name,
            "type" => _profile_type,
        ...
        $show = show($dir . "/form_profil_edit", array(
            "name" => _profile_name,
            "p_name" => re($get['name']),
            "kat" => _profile_kat,
            "type" => _profile_type,
        ...
        while ($get = _fetch($qry)) {
            ...
            $show_about .= show($dir . "/profil_show", array(
                "class" => $class,
                "name" => re($get['name']),
                "type" => $type,
                "shown" => $shown,
        ...
        while ($get = _fetch($qry)) {
            ...
            $show_clan .= show($dir . "/profil_show", array(
                "class" => $class,
                "name" => re($get['name']),
                "type" => $type,
                "shown" => $shown,
        ...
        while ($get = _fetch($qry)) {
            ...
            $show_contact .= show($dir . "/profil_show", array(
                "class" => $class,
                "name" => re($get['name']),
                "type" => $type,
                "shown" => $shown,
        ...
        while ($get = _fetch($qry)) {
            ...
            $show_favos .= show($dir . "/profil_show", array(
                "class" => $class,
                "name" => re($get['name']),
                "type" => $type,
                "shown" => $shown,
        ...
        while ($get = _fetch($qry)) {
            ...
            $show_hardware .= show($dir . "/profil_show", array(
                "class" => $class,
                "name" => re($get['name']),
                "type" => $type,
                "shown" => $shown,
