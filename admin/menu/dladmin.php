...
if (!permission("downloads")) {
    ...
    if ($_GET['do'] == "new") {
        ...
        for ($i = 0; $i < count($files); $i++) {
            $dl .= show(_downloads_files_exists, array(
                "dl" => $files[$i],
                "sel" => ""
            ));
        }
        
        $show = show($dir . "/form_dl", array(
            "admin_head" => _downloads_admin_head,
            "ddownload" => "",
            "durl" => "",
            "oder" => _or,
            "lang" => $language,
        ...
        $show = show($dir . "/form_dl", array(
            "admin_head" => _downloads_admin_head_edit,
        ...
        while ($get = _fetch($qry)) {
            ...
            $color++;
            $show_ .= show($dir . "/downloads_show", array(
                "id" => $get['id'],
                "dl" => re($get['download']),
                "class" => $class,
                "edit" => $edit,
