...
if (!permission("awards")) {
    ...
    if ($_GET['do'] == "new") {
        ...
        $show = show($dir . "/form_awards", array(
            "head" => _awards_admin_head_add,
        ...
        while ($gets = _fetch($qrym)) {
            ...
            $squads .= show(_awards_admin_edit_select_field_squads, array(
                "id" => $gets['id'],
                "name" => re($gets['name']),
                "game" => re($gets['game']),
                "icon" => re($gets['icon']),
        ...
        while ($get = _fetch($qry)) {
            ...
            $show_ .= show($dir . "/awards_show", array(
                "datum" => date("d.m.Y", $get['date']),
                "award" => re($get['event']),
                "id" => $get['squad'],
                "class" => $class,
                "edit" => $edit,
