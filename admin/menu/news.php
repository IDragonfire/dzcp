...
if (!permission("news") && !permission('artikel')) {
    ...
    while ($get = _fetch($qry)) {
        ...
        $img    = show(_config_newskats_img, array(
            "img" => re($get['katimg'])
        ));
        
        $class = ($color % 2) ? "contentMainSecond" : "contentMainFirst";
        $color++;
        $kats .= show($dir . "/newskats_show", array(
            "mainkat" => re($get['kategorie']),
            "class" => $class,
            "img" => $img,
            "delete" => $delete,
            "edit" => $edit
    ...
    $show = show($dir . "/newskats", array(
        "head" => _config_newskats_head,
        "kats" => $kats,
    ...
    if ($_GET['do'] == "delete") {
        ...
        $show = show($dir . "/newskatform", array(
            "head" => _config_newskats_add_head,
        ...
        $upload = show(_config_neskats_katbild_upload_edit, array(
            "id" => $_GET['id']
        ));
        $do     = show(_config_newskats_editid, array(
            "id" => $_GET['id']
        ));
        
        $show = show($dir . "/newskatform", array(
            "head" => _config_newskats_edit_head,
            "nkat" => _config_katname,
