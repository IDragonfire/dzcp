...
if (!permission("rankings")) {
    ...
    if ($_GET['do'] == "add") {
        ...
        $show = show($dir . "/form_rankings", array(
            "head" => _rankings_add_head,
            "do" => "addranking",
        ...
        while ($get = _fetch($qry)) {
            ...
            $show_ .= show($dir . "/rankings_show", array(
                "squad" => re($get['name']),
        ...
        $show = show($dir . "/rankings", array(
            "head" => _config_rankings,
