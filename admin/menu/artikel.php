...
if (permission("artikel")) {
    ...
    if ($_GET['do'] == "add") {
        ...
        $show = show($dir . "/artikel_form", array(
            "head" => _artikel_add,
            "nautor" => _autor,
            "autor" => autor($userid),
        ...
        $do = show(_artikel_edit_link, array(
            "id" => $_GET['id']
        ));
        ...
        while ($get = _fetch($qry)) {
            ...
            $titel  = show(_artikel_show_link, array(
