    ...
    if ($_GET['do'] == "step2") {
        if (empty($_POST['gallery'])) {
            ...
            for ($i = 1; $i <= $_POST['anzahl']; $i++) {
                $addfile .= show($dir . "/form_gallery_addfile", array(
                    "file" => _gallery_image,
                    "i" => $i
                ));
            }
        ...
        $show = show($dir . "/form_gallery_edit", array(
            "head" => _gallery_admin_edit,
        ...
        $show = show($dir . "/form_gallery_new", array(
            "head" => _gallery_admin_edit,
        ...
        $show = show($dir . "/form_gallery", array(
            "head" => _gallery_admin_head,
            "gallery" => _gallery_gallery,
            "beschr" => _beschreibung,
            "value" => _error_fwd,
        ...
        while ($get = _fetch($qry)) {
            ...
            $color++;
            $show .= show($dir . "/gallery_show", array(
                "link" => re($get['kat']),
                "class" => $class,
                "del" => $del,
                "edit" => $edit,
