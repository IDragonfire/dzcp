...
switch ($do) {
    case "add":
        ...
        $files = get_files(basePath.'/inc/images/gameicons/',false,true,array('gif','png','jpg'));
        $gameicons = '';
    ...
    case 'edit':
        ...
        $files = get_files(basePath.'/inc/images/gameicons/',false,true,array('gif','png','jpg')); $gameicons = '';
        foreach ($files as $file)
        {
