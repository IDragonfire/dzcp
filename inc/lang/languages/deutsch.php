...
define('_admin_squads_nav_info', 'Hiermit wird ein Direktlink in die Navigation gesetzt, welcher zur Vollansicht des Teams f�hrt.');
...
define('_installdir', "<tr><td colspan=\"15\" class=\"contentMainFirst\"><br /><center><b>Achtung! Sicherheitsrisiko!!</b><br><br>Bitte l&ouml;sche zuerst den Ordner <b>'/_installer'</b> von deinem Webspace. Erst dann steht das Adminmen� zur Verf�gung!</center><br /></td></tr>");
...
define('_sponsor_deleted', 'Sponsor erfolgreich gel�scht!');
...
define('_away_error_2', 'Das Startdatum ist gr��er als das Enddatum!');
define('_away_to', 'bis');
...
define('_news_send_note', 'Mitteilung o. Hinweis f�r die Redaktion');
define('_news_send_done', 'Vielen Dank! Die News wurde erfolgreich an die Redaktion weitergeleitet');
define('_news_send_description', 'Liebe Besucher,<br /><br />mit dem folgenden Formular ist es m�glich im Netz gefundene, oder selbst erstellte News an uns zu senden. Der von Dir ausgef�llte Formularinhalt wird dann mittels eines Verteilers an unsere Redakteure weitergeleitet. Bitte bedenke, dass wir jede Einsendung aufbereiten und evtl. genauere Details recherchieren m�ssen, um die gewohnte Qualit�t unserer News beizubehalten. Dies f�llt uns nat�rlich leichter, wenn Deine Einsendung bereits viele Einzelheiten aufweist und selbst formulierte Texte beinhaltet. Meldungen die lediglich 1:1 von anderen Seiten kopiert wurden, erschweren unsere Arbeit und verhindern nicht selten eine Ver�ffentlichung der Einsendung auf unserer Hauptseite.<br /><br />Nat�rlich sind wir �ber jede von Dir eingesendete News dankbar und freuen uns �ber das Engagement unserer Besucher.<br /><br />Vielen Dank im Voraus.<br /><br />Dein Redaktions-Team');
...
<tr>
  <td align="center" class="contentMainTop"><span class="fontBold">Damit die anderen Redakteure wissen, dass du diese News ver�ffentlichen wirst,<br />klicke bitte auf den nachfolgenden Button. Danke</span></td>
</tr>
<tr>
...
define('_send_news_done', 'Vielen Dank f�r das Best&auml;tigen und das einstellen des Newsvoschlags!');
...
define('_foum_fabo_checkbox', 'Diesen Thread abonnieren und per E-Mail �ber neue Posts benachrichtigt werden?');
...
define('_forum_nobody_is_online2', 'Zur Zeit ist kein User au�er dir im Forum online!');
## G�stebuch ##
...
<span class="fontBold">Team:</span> [squad]<br /><br />
<span class="fontUnder"><span class="fontBold">Nachricht:</span></span><br />[text]');
define('_contact_joinus_no_squad_aviable', 'Kein Team verf�gbar');
...
define('_error_passwords_dont_match', 'Die eingegebenen Passw&ouml;rter stimmen nicht �berein!');
...
define('_download_size', 'Dateigr&ouml;�e:');
