...
function infos($checkBrowser = "") {
    ...
    if(settings('persinfo')) {
	  ...
	  $windows8_icon = ' <img style="vertical-align:middle" alt="" src="../inc/images/info/windows8_os.png" width="16" height="16" /> ';
      ...
      elseif(preg_match("/Windows XP/i",$data) || preg_match("/NT 5.1/i",$data)) $system = $windows_icon."Windows XP";
      ...
      elseif(preg_match("/NT 6.2/i",$data))                   					 $system = $windows8_icon."Windows 8";
      elseif(preg_match("/NT 6.3/i",$data))                   					 $system = $windows8_icon."Windows 8.1";
