...
<head>
	<title>{#dzcp.vimeo}</title>
	<script language="javascript" type="text/javascript" src="../../tiny_mce_popup.js"></script>
	<script language="javascript" type="text/javascript" src="jscripts/vimeo.js"></script>
	<base target="_self" />
</head>
...
<form name="source" onSubmit="saveContent();">
    ...
    <b>{#dzcp.vimeo_link}:</b> <input id="linkSource" type="text" value="" style="width:420px" /> <br />
    e.g. http://vimeo.com/11020052 <br>ID: 11020052
