...
<head>
	...
	<script language="javascript" type="text/javascript" src="jscripts/golemvideo.js"></script>
	<base target="_self" />
</head>
...
<form name="source" onSubmit="saveContent();">
    ...
    <b>{#dzcp.golemvideo_link}:</b> <input id="linkSource" type="text" value="" style="width:420px" /> <br />
    e.g. http://video.golem.de/internet/3872/neue-facebook-gruppen.html?q=medium <br>ID: 3872
