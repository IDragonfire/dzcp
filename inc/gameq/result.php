...
class GameQ_Result
{
    ...
    /**
     * Adds Channel variable to output
     *
     * @param       string   $name      Variable name
     * @param       string   $value     Variable value
     */
    public function addChannels($name, $value)
    {
        $this->addSub('channels', $name, $value);
    }

    /**
     * Adds Channel Grouplist variable to output
     *
     * @param       string   $name      Variable name
     * @param       string   $value     Variable value
     */
    public function addCgrouplist($name, $value)
    {
        $this->addSub2('channel_grouplist', $name, $value);
    }

    /**
     * Adds Server Grouplist variable to output
     *
     * @param       string   $name      Variable name
     * @param       string   $value     Variable value
     */
    public function addSgrouplist($name, $value)
    {
        $this->addSub2('server_grouplist', $name, $value);
    }
     ...
     */
    public function addSub2($sub, $key, $value)
    {
