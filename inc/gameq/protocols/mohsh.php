...
class GameQ_Protocols_Mohsh extends GameQ_Protocols_Gamespy
{
    ...
    protected $basic_game_dir = 'mohaas';
    ...
    */
    protected function process_dzcp_runtime()
    {
        ...
        {
            DebugConsole::insert_info('GameQ_Protocols_Mohsh::process_dzcp_runtime()', 'The basic-gamedir differs from servers gamedir, use a mod?');
            DebugConsole::insert_info('GameQ_Protocols_Mohsh::process_dzcp_runtime()', 'Basic: "'.$this->basic_game_dir.'" <=> Server: "'.$this->server_data_stream['gamename'].'" on Server '.$this->server_data_stream['gq_address'].':'.$this->server_data_stream['gq_port']);
        ...
        $result->add('game_map_pic_dir', 'mohaa/'.($this->is_mod || $is_mod_ml ? $this->server_data_stream['gamename'] : $this->basic_game_dir) );
        ...
        if($this->server_data_stream['gq_online'] == '1')
            GameQ::mkdir_img('maps/mohaa/'.($this->is_mod || $is_mod_ml ? $this->server_data_stream['gamename'] : $this->basic_game_dir));
