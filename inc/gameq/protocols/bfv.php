...
class GameQ_Protocols_Bfv extends GameQ_Protocols_Gamespy2
{
    ...
    protected $basic_game_dir = 'bfvietnam';
    ...
    */
    protected function process_dzcp_runtime()
    {
        ...
        $this->server_data_stream['active_mods'] = empty($this->server_data_stream['active_mods']) ? 'bfvietnam' : $this->server_data_stream['active_mods'];
        ...
        {
            DebugConsole::insert_info('GameQ_Protocols_Bfv::process_dzcp_runtime()', 'The basic-gamedir differs from servers gamedir, use a mod?');
            DebugConsole::insert_info('GameQ_Protocols_Bfv::process_dzcp_runtime()', 'Basic: "'.$this->basic_game_dir.'" <=> Server: "'.$this->server_data_stream['active_mods'].'" on Server '.$this->server_data_stream['gq_address'].':'.$this->server_data_stream['gq_port']);
        ...
        */
        ...
        {
            $teams[$key+1] = array('team_name' => $data['teamt'], 'team_score' => $data['ticketst']);
        }
