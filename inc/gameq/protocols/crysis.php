...
class GameQ_Protocols_Crysis extends GameQ_Protocols_Gamespy3
{
    ...
    */
    protected function process_dzcp_runtime()
    {
        ...
        $result->add('game_map_pic_dir', 'gamespy3/cryengine/crysis'.($this->is_mod || $is_mod_ml ? '/'.$this->server_data_stream['gamemode'] : '') );
        $result->add('game_type',ucfirst($this->server_data_stream['gametype']));
        $result->add('game_dir', !$this->is_mod && !$is_mod_ml ? 'crysis' : $this->server_data_stream['gamemode']);
        ...
        if($this->server_data_stream['gq_online'] == '1')
            GameQ::mkdir_img('maps/gamespy3/cryengine/crysis/'.($this->is_mod || $is_mod_ml ? $this->server_data_stream['gamemode'] : $this->basic_game_dir));
