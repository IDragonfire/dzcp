 ...
 *
 *
 * Modified by Godkiller_NT (Hammermaps.de) for DZCP-Extended Edition 03-09-2013 (mm-dd-yyyy)
 *
 */
...
abstract class GameQ_Protocols_Core
{
    ...
    const PACKET_SGROUPLIST = 'sgid'; // Voice servers
    const PACKET_CGROUPLIST = 'cgid'; // Voice servers
    ...
    /**
     * Save Servers Streamdata
     *
     * @var array
     */
    protected $server_data_stream = array();
