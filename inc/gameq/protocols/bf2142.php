...
class GameQ_Protocols_Bf2142 extends GameQ_Protocols_Gamespy3
{
    ...
    */
    protected function process_dzcp_runtime()
    {
        ...
        {
            DebugConsole::insert_info('GameQ_Protocols_Bf2142::process_dzcp_runtime()', 'The basic-gamedir differs from servers gamedir, use a mod?');
            DebugConsole::insert_info('GameQ_Protocols_Bf2142::process_dzcp_runtime()', 'Basic: "'.$this->basic_game_dir.'" <=> Server: "'.$this->server_data_stream['gamevariant'].'" on Server '.$this->server_data_stream['gq_address'].':'.$this->server_data_stream['gq_port']);
        ...
        $secure = array('enable' => $this->server_data_stream['bf2142_anticheat'] == '1' ? true : false, 'pic' => 'punkbuster', 'name' => 'PunkBuster');
        ...
        $result->add('game_region',$this->server_data_stream['bf2142_region']);
        ...
        $result->add('game_engine', 'battlefield2142');
