        ...
        if (_rows($qry)) {
            while ($get = _fetch($qry)) {
                ...
                if ($get['reg'] == $userid || permission("gb")) {
                    ...
                    $comment = show(_gb_commenticon, array(
                        "id" => $get['id'],
                ...
                if ($get['reg'] == "0") {
                    $gbtitel = show(_gb_titel_noreg, array(
                        "postid" => $i,
                        "nick" => re($get['nick']),
                        "edit" => $edit,
                        "delete" => $delete,
    ...
    case 'admin';
        if (!permission("gb")) {
            ...
            if ($_GET['do'] == "addcomment") {
                ...
                $index = show($dir . "/gb_addcomment", array(
                    "head" => _gb_addcomment_head,
                    "entry" => $entry,
                    "what" => _button_value_add,
                    "id" => $_GET['id'],
                ...
                $comment = show($dir . "/commentlayout", array(
                    "nick" => autor($userid),
