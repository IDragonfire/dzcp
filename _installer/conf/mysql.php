...
(5, 'eSport-Designs', 'http://esport-designs.de', '<p>Jedes Team das keine gut strukturierte und übersichtlich gestaltete Webseite besitzt, die sich von der breiten Masse abhebt, gelingt es schwer oder teilweise gar nicht sich im Web zu präsentieren. eSport-Designs bietet vorgefertigte DZCP Templates, Logo Designs oder Onlineshop Lösungen komplett nach Kundenwunsch an.</p>', 1, '', '../banner/sponsors/ed468x60.png', 1, '', '../banner/sponsors/ed468x60.png', 1, '', '../banner/sponsors/ed88x31.gif', 8, 0);");
