...
//-> Settings
  ...
  $qry = db("CREATE TABLE ".$db['settings']." (
             ...
             `reg_forum` int(1) NOT NULL default '0',
             `reg_cwcomments` int(1) NOT NULL default '0',
             ...
             `reg_dl` int(1) NOT NULL default '0',
             `reg_artikel` int(1) NOT NULL default '0',
             `reg_newscomments` int(1) NOT NULL default '0',
...
function update_mysql_1_4()
{
  ...
  $qry = db("ALTER TABLE ".$db['settings']." ADD `id` int(1) NOT NULL default '1' FIRST,
                                             ...
                                             ADD `reg_shout` int(1) NOT NULL default '0',
