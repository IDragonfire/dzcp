...
$mm_qry        = db('SELECT u.`id`, u.`nick`, u.`city`, u.`gmaps_koord` FROM ' . $db['users'] . ' u WHERE u.`gmaps_koord` != "" AND u.`level` > ' . $level . ' ORDER BY u.gmaps_koord, u.id');
$mm_coords     = '';
$mm_infos      = "'<tr>";
$mm_markerIcon = '';
$mm_lastCoord  = '';
...
$index    = show($dir . "/membermap", array(
    'head' => _membermap,
    'mm_coords' => $mm_coords,
    'mm_infos' => $mm_infos,
