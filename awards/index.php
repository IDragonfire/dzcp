...
switch ($action):
    default:
        ...
        while ($get = _fetch($qry)) {
            ...
            while ($getm = _fetch($qrym)) {
                ...
                $event = show(_awards_event, array(
                    "event" => re($getm['event']),
                    "url" => $getm['url']
                ));
                
                $awards .= show($dir . "/awards_show", array(
                    "class" => $class,
            ...
            if (cnt($db['awards'], " WHERE squad = " . $get['id']) > $maxawards)
                $show_all = show(_list_all_link, array(
                    "id" => $get['id']
                ));
            else
                $show_all = "";
            
            $showawards = show($dir . "/awards", array(
        ...
        if ($anz_place_1 != "0") {
            $place1_balken = show(_votes_balken, array(
                "width" => $place1_rawpercent
            ));
        } else {
            $place1_balken = $place1_balken = show(_votes_balken, array(
                "width" => 1
            ));
        }
        if ($anz_place_2 != "0") {
            $place2_balken = show(_votes_balken, array(
                "width" => $place2_rawpercent
            ));
        } else {
            $place2_balken = show(_votes_balken, array(
                "width" => 1
        ...
        if ($anz_place_3 != "0") {
            $place3_balken = show(_votes_balken, array(
                "width" => $place3_rawpercent
            ));
        } else {
            $place3_balken = show(_votes_balken, array(
                "width" => 1
        ...
        $anz_awards_out  = show(_awards_stats, array(
            "anz" => $anz_awards
        ));
        $anz_place_1_out = show(_awards_stats_1, array(
            "anz" => $anz_place_1
        ));
        $anz_place_2_out = show(_awards_stats_2, array(
            "anz" => $anz_place_2
        ));
        $anz_place_3_out = show(_awards_stats_3, array(
            "anz" => $anz_place_3
        ));
        
        $stats = show($dir . "/stats", array(
            "head_stats" => _head_stats,
        ...
        if (cnt($db['awards']) != 0)
            ...
            $show_ = show(_no_entrys_yet, array(
                "colspan" => "10"
            ));
    ...
    case 'showall';
        ...
        while ($get = _fetch($qry)) {
            ...
            $showawards = show($dir . "/awards_show_all", array(
                "squad" => _awards_head_squad,
                "date" => _awards_head_date,
                "place" => _awards_head_place,
                "prize" => _awards_head_prize,
            ...
            if (cnt($db['awards'], " WHERE squad = " . $get['id']) != 0) {
                $show .= show($dir . "/squads_show_all", array(
                    "id" => $get['id'],
                    "shown" => $shown,
                    "display" => $display,
                    "awards" => $showawards,
        ...
        $stats = show(_awards_stats, array(
            "anz" => cnt($db['awards'])
        ));
